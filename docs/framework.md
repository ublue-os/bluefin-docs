...
Bluefin and it's sister image [Aurora](https://getaurora.dev) are community supported options on Framework hardware. The sister image [Bazzite](https://bazzite.gg) is even officially supported.
