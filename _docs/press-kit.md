...
- `uBlue`, `UBlue`, `ublue-os`, or any contraction of the term. These shorthand names are commonly used as slugs in URLs, path's in the operating system such as `/usr/share/ublue-os`
