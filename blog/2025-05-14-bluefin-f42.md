...
- We really, really made some efficiency gains across Universal Blue this cycle, we were able to grow our team while getting faster.
  - We’ve centralized a ton of things from the individual images to the [packages repo](https://github.com/ublue-os/packages) - our team slayed here, with Tulip and Zeglius leading the work. This has led to more sharing and reviewing across the board. This is also a great place to get started contributing!
