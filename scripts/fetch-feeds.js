...
async function main() {
  await fetchAndParseFeed('https://github.com/ublue-os/bluefin/releases.atom', 'bluefin-releases.xml');
  await fetchAndParseFeed('https://github.com/ublue-os/bluefin-lts/releases.atom', 'bluefin-lts-releases.xml');
}
